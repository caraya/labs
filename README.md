...
hugo-strange is a fork of Netlify's [victor-hugo](https://github.com/netlify/victor-hugo) boilerplate with
...
Run `gulp --tasks` to get a list of everything that is available as part of the build process.
